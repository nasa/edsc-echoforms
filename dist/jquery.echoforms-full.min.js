...
/***/ function(module, exports, __webpack_require__) {
	...
	EchoForm = (function() {
	  ...
	  function EchoForm(root, options) {
	    var controlClasses, doc, exception, expression, expressions, expressionsAllOthers, expressionsFirefox, form, i, len, model, prepopulate, ref, resolver, source, timer, ui;
	    this.root = root;
	    try {
	      ...
	      timer = false;
	      $('.jstree').on('keyup', '#band-filter', function() {
	        if (timer) {
	          clearTimeout(timer);
	        }
