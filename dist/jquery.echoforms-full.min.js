...
/***/ function(module, exports, __webpack_require__) {
	...
	EchoForm = (function() {
	  ...
	  function EchoForm(root, options) {
	    var base, base1, checkedCount, controlClasses, doc, exception, expression, expressions, expressionsAllOthers, expressionsFirefox, form, i, len, model, prepopulate, ref, resolver, skipValidation, source, timer, totalCount, ui;
	    this.root = root;
	    try {
	      ...
	      timer = false;
	      $('.jstree').on('keyup', '#bands-filter', function() {
	        if (timer) {
	          clearTimeout(timer);
	        }
	        return timer = setTimeout((function() {
	          ...
	          if (text.length > 1) {
	            return $('.jstree').jstree(true).search(text);
	          }
	        }), 250);
	      });
	      totalCount = typeof (base = $('.jstree').jstree(true)).get_json === "function" ? base.get_json('#', {
	        flat: true
	      }).length : void 0;
	      $('.jstree').on('click', '.jstree-node', function(e) {
	        var checkedCount;
	        checkedCount = $('.jstree').jstree(true).get_selected().length;
	        return $('#bands-count').text(checkedCount + "/" + totalCount + " bands selected");
	      });
	      checkedCount = typeof (base1 = $('.jstree').jstree(true)).get_selected === "function" ? base1.get_selected().length : void 0;
