...
/***/ function(module, exports, __webpack_require__) {
	...
	Grouping = (function(superClass) {
	  ...
	  Grouping.prototype.validate = function() {
	    var control, i, len, prune, ref, relevant;
	    Grouping.__super__.validate.call(this);
	    prune = true;
	    ref = this.controls;
	    for (i = 0, len = ref.length; i < len; i++) {
	      control = ref[i];
	      relevant = (control.relevantExpr == null) || !!control.xpath(control.relevantExpr);
	      if (!relevant && control.relevant()) {
	        prune = false;
	      }
	      control.validate();
	    }
	    if (!prune) {
	      return this.ref()[0].removeAttribute('pruned');
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	EchoForm = (function() {
	  ...
	  function EchoForm(root, options) {
	    var checkedCount, controlClasses, doc, exception, expression, expressions, expressionsAllOthers, expressionsFirefox, form, i, len, model, prepopulate, ref, resolver, source, timer, totalCount, ui;
	    this.root = root;
	    try {
	      ...
	      totalCount = $('.jstree').jstree(true).get_json('#', {
	        flat: true
	      }).length;
