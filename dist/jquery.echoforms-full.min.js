	...
	Tree = (function(superClass) {
	  ...
	  Tree.prototype.inputValue = function() {
	    ...
	    checked = all_nodes.filter(function(node) {
	      var ref;
	      return node.state.selected && ((ref = node.li_attr.node_value) != null ? ref.length : void 0) > 0 && node.li_attr['item-relevant'] === 'true';
	    });
	    required = all_nodes.filter(function(node) {
	      var ref;
	      return node.li_attr['item-relevant'] === 'true' && node.li_attr['item-required'] === 'true' && ((ref = node.li_attr.node_value) != null ? ref.length : void 0) > 0 && node.children.length === 0;
	    });
	          ...
	          for (k = 0, len = ref.length; k < len; k++) {
	            ...
	            if (sibling.state.selected) {
	              if (sibling.li_attr['item-relevant'] === 'true') {
	                return _this._hasIrrelevantDescendants(sibling);
	              } else {
	                return true;
	              }
	            } else {
	  ...
	  Tree.prototype._getLeafStats = function() {};
	  ...
	  Tree.prototype.buildElementsDom = function() {
	    ...
	    root.jstree({
	      ...
	      var arr1, arr2, bandsCountId, bandsFilterId, checkedLeafs, k, l, len, len1, node, ref, ref1, rootBandId, selectedBandsId, totalLeafs;
	      ...
	      for (k = 0, len = ref.length; k < len; k++) {
	        ...
	        if (root.jstree('is_leaf', node)) {
	          totalLeafs = (arr1 || (arr1 = [])).push(node);
	        }
	      }
	      ref1 = root.jstree('get_checked');
	      for (l = 0, len1 = ref1.length; l < len1; l++) {
	        node = ref1[l];
	        if (root.jstree('is_leaf', node) && !root.jstree('is_disabled', node)) {
	          checkedLeafs = (arr2 || (arr2 = [])).push(node);
	        }
	      }
	      if (checkedLeafs == null) {
	        checkedLeafs = 0;
	      }
	      ...
	      var arr1, arr2, bandsCountId, checkedLeafs, k, l, len, len1, node, ref, ref1, selectedBandsId, totalLeafs;
	      ref = root.jstree('get_json', '#', {
	        flat: true
	      });
	      for (k = 0, len = ref.length; k < len; k++) {
	    ...
	    }).on('keyup', '#' + $(this).attr('id') + "-bands-filter", function() {
	      if (timer) {
	        clearTimeout(timer);
	      }
