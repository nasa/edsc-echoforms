...
describe('setRelevantAttribute', () => {
  ...
  it('adds the irrelevant attribute to an element when the xpath is absolute and within a group', () => {
    ...
    expect(setRelevantAttribute(model, resolver, '//prov:group1/prov:group2/prov:reference', false).outerHTML).to.eq('<prov:group2 xmlns:prov="http://www.example.com/orderoptions"><prov:reference irrelevant="true">test</prov:reference></prov:group2>')
  })
})
